...
#    Executar script via ARQUIVO no Banco de Dados       ${CURDIR}/scripts/create_table_accounts.sql
#    Executar script via ARQUIVO no Banco de Dados       ${CURDIR}/scripts/insert_into_account.sql
